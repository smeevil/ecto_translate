defmodule EctoTranslate do
  ...
  defmacro __using__(fields) do
    ...
    translate_ast =
      quote do
        ...
        """
        @spec translate!(model :: Ecto.Schema.t() | List.t()[Ecto.Schema.t()], locale :: Atom.t()) ::
                Ecto.Schema.t() | List.t()[Ecto.Schema.t()]
  ...
  """
  @spec set(model :: Ecto.Schema.t(), options :: List.t()[{Atom.t(), Any.t()}]) ::
          :ok | {:error, List.t()}
